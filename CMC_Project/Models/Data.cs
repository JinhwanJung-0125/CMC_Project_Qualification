...
namespace SetUnitPriceByExcel
{
    class Data
    {
        ...
        public static double? PersonalRateNum; //사정율
        public static decimal? priceA; //A값
        public static double? laborPercent;     //노무비 기준율
        public static double? expencePercent;   //기타 경비 기준율
        public static double? managementPercent;    //일반 관리비 기준율
        public static double? profitPercent;    //이윤 기준율
        public static decimal? BasePrice;   //기초금액
        ...
        public static decimal PersonalRate
        {
            get
            {
                return Convert.ToDecimal(PersonalRateNum * 0.01);  //입력받은 PersonalRateNum(double? 형)을 decimal로 바꿈 / 조달청 기준 단가 공식에서 예가 산출율을 소수점 셋째자리 이하에서 절사하므로 똑같이 절사함 (23.02.07)
            }
        }    //내 예가 사정률
